class Views {
    ...
    constructor(mapView, favorisView, navItems, organismPopup, firebaseDB) {
    ...
    init(){
        ...
        .finally( () => {
            ...
            .then( establishments => {
                establishments.forEach( establishment =>  this.markers.push(this.getMarker(establishment)) )
            })
